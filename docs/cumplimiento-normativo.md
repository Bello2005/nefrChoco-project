...
| Género, etnia, discapacidad, ocupación, zona, tipo de afiliación | Ficha, cifrados; hoy como texto | `Pacientes/IdentidadPacienteTest` | 🟡 confirmar los catálogos en el paquete del IHCE | Bello / IPS |
...
| Requisito | Dónde se cumple | Prueba Pest | Estado | Responsable |
|---|---|---|---|---|
| Datos de la atención codificados (diagnóstico, procedimiento, finalidad, causa externa) | Registro estructurado de la atención | `Atencion/RegistroAtencionTest` | 🟡 los catálogos de finalidad, causa externa y tipo de diagnóstico están en `[CONFIRMAR]` | Bello |
